...
/**
 * Creates an expand/collapse container with a title to toggle expand/collapse.
 */
public class ExpandPlugin extends JspPlugin
{

    public ExpandPlugin()
    {
        this("expand", "expand.jsp");
    }

    public ExpandPlugin(String name, String jspPath)
    {
        ...
        addParameterDescription(ParameterDescription.find("class").defaultValue("wiki_expand"));
    }
